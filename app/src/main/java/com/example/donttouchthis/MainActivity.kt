...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragmentW: FileChooserFragment =
            supportFragmentManager.findFragmentById(R.id.fragment_fileChooser) as FileChooserFragment
        val fragmentB: FileChooserFragment =
            supportFragmentManager.findFragmentById(R.id.fragment_fileChoose2r) as FileChooserFragment
